...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 390, 15, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 120, 330, 10, 10, 1, 200),
    new ZombieCaminante('imagenes/zombie2.png', 70, 250, 10, 10, 1, 100),
    new ZombieCaminante('imagenes/zombie3.png', 450, 60, 10, 10, 1.5, 400),
    new ZombieCaminante('imagenes/zombie4.png', 400, 350, 10, 10, 1.5, 100),
    new ZombieCaminante('imagenes/zombie2.png', 750, 320, 10, 10, 2, 150),

    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 10, 977, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 675, 0, 30, 90, 3, 977, 'v'),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 10, 977, 'h')
    ]
...
Juego.capturarMovimiento = function (tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
    this.jugador.movimiento(movX + this.jugador.x, movY + this.jugador.y,tecla);
    /* COMPLETAR */
  }
};
...
Dibujante.dibujarRectangulo('red',760,560,130,10);
